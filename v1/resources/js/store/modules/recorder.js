...
export const actions = {
		...
		stopRecording 		: function({ state, commit, dispatch }){
			...
			state.record.recorder && state.record.recorder.exportWAV(function(audio){

				commit('setRecordedAudio', { file : audio, url : URL.createObjectURL(audio) });
