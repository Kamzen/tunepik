	...
	<div class="wrapper">
		...
		<div class="navbar fixed-bottom" v-if="!record.done">
			...
			<div class="button-wrapper" style="width: 100%;" v-if="record.isRecording">
				...
				<button class="btn btn-info mobile-share-control-btn send-post-xs yes" v-on:click="stopRecording()">Stop Recording</button>
		    <button class="btn btn-danger mobile-share-control-btn cancel-post-xs no" v-on:click="cancelRecording()">Cancel</button>
